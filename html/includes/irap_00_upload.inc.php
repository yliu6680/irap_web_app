...
<div class="irap-title">
  <div class="container">
    ...
    <p>The fastq files should be valid, and corresponded to the meta data file (must be csv file), which means that names of the fastq files in your metadata should be the same with your uploaded fastq files.</p> 
  </div>
</div>
...
if(!empty($_POST)){
  ...
  echo "<div class='padding-top'></div>";  
...
<br>
<br><a class='btn irap-btn' href='irap_01_conf.php' role='botton'>Next: iRAP options</a>";
