...
if (isset($_POST['name'])) {
  ...
  $json_dir="/var/www/html/users/".$_SESSION['usrname'].'/'.$_SESSION['md5_code'].'/irap_options.json';
  ...
  $cmd = shell_exec("python3 ".$script_dir." --name=".$name." --species=".$species." --reference=".$reference_dir." --gtf_file=".$gtf_dir." --user_trans=".$user_trans." --data_dir=".$raw_data_dir." --cont_index=".$cont_index." --mapper=".$mapper." --quant_method=".$quantification." --quant_norm_tool=irap --quant_norm_method=fpkm --de_method=".$DE_methods." --template_dir=".$template_dir." --output_dir=".$output_dir." --meta_data=".$meta_data." --json_dir=".$json_dir." 2>&1");
